    ...
    namespace kernel
    {
        namespace sync_push_td
        {
                          ...
                          BitmapDeviceObject in_active)
            {
                ...
                const uint32_t work_size = seg_enode - seg_snode;
                ...
                PushFunctorDB<TAppInst, CSRGraph, GraphDatum, TBuffer, TWeight>
                        ...
                        for (index_t i = 0 + tid; i < work_size_rup; i += nthreads)
                        {
                            ...
                            if (i < work_size)
                            {
                                const index_t node = i + seg_snode;
            ...
            //           typename TBuffer,
            //           typename TWeight>
            // __forceinline__ __device__ void RelaxCTADB(TAppInst app_inst,
            //                                            index_t seg_snode,
            //                                            index_t seg_enode,
            //                                            uint64_t seg_sedge_csr,
            //                                            bool zcflag,
            ...
            //         {
            //         case LoadBalancing::COARSE_GRAINED:
            //             groute::dev::CTAWorkSchedulerNew<Payload<TBuffer>, groute::dev::LB_COARSE_GRAINED>::template schedule(np_local, push_functor);
            //             break;
            //         case LoadBalancing::FINE_GRAINED:
            //             groute::dev::CTAWorkSchedulerNew<Payload<TBuffer>, groute::dev::LB_FINE_GRAINED>::template schedule(np_local, push_functor);
            //             break;
            //         case LoadBalancing::HYBRID:
            //             groute::dev::CTAWorkSchedulerNew<Payload<TBuffer>, groute::dev::LB_HYBRID>::template schedule(np_local, push_functor);
            //             break;
            //         default:
            //             assert(false);
            //         }
